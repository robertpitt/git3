...
`.git/git3/HEAD` is trusted as a repository administrator. git3 never accepts credentials in its URL
or copies them into Git configuration and redacts authorization material from diagnostics.
